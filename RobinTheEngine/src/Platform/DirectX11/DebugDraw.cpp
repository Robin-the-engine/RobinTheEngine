...
namespace RTE
{
        ...
        FXMVECTOR color)
    {
        ...
        RTE::DrawRing(batch, origin, xaxis, zaxis, color);
        RTE::DrawRing(batch, origin, xaxis, yaxis, color);
        RTE::DrawRing(batch, origin, yaxis, zaxis, color);
    }
        ...
        FXMVECTOR color)
    {
        ...
        RTE::DrawCube(batch, matWorld, color);
    }
